...
public class SimpleDB {
   ...
   private static int gClockRefCount = 0;
    ...
    */
   public static void init(String dirname, int gClockRefCount1) {
	  System.out.println("GClock policy being used: Ref Count = "
				+ gClockRefCount1);

	  gClockRefCount = gClockRefCount1;
   ...
   public static int getgClockRefCount() {
	return gClockRefCount;
}

public static void setgClockRefCount(int gClockRefCount) {
	SimpleDB.gClockRefCount = gClockRefCount;
}
